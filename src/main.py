...
Description:
    The script takes a path to a configuration file as a command-line
    argument, opens CANoe, loads the configuration file, starts a measurement,
    and then stops the measurement and closes CANoe.
...
DEBUG_CONFIG_PATH = './config.cfg'
 
# Path to the slave_tool1 executable.
# WARNING: This path is hard-coded and may need to be updated if the location of
# slave_tool1 changes.
...
def modify_config(config_path):
    ...
    This function opens the configuration file, makes some modifications, and
...
if __name__ == "__main__":
    ...
    parser.add_argument('config_path',
                        nargs='?',
                        default=DEBUG_CONFIG_PATH,
                        help='The path to the configuration file to load.')
    parser.add_argument('--output_dir',
                        default=DEFAULT_OUTPUT_DIR,
                        help='The directory where the test report should be saved.')
